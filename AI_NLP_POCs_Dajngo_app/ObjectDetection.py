...
labels = open('C:/Users/RNALAB/Downloads/object/src_code/bin/coco.names').read().strip().split('\n')
...
weights_path = 'C:/Users/RNALAB/Downloads/object/src_code/bin/yolov4.weights'
# loading the configaration file of Yolo3
#configuration_path = 'C:/Users/RNALAB/Downloads/Object/bin/yolov3.cfg'
configuration_path = 'C:/Users/RNALAB/Downloads/object/src_code/bin/yolo4.cfg'
...
def detection(input_image_path):
    ...
    try:
        ...
        cv2.imwrite('C:/Users/RNALAB/Documents/ImageClassification_test/media/model_output2.jpg', image_input)
