...
def transcription(file):
    ...
    filename = 'C:/Users/tuhin.majumder/Pictures/ImageClassification_test_DSS/media/saved_image.jpg'
    img1.save(filename)
    img = cv2.imread(filename)
    cv2.imwrite('C:/Users/tuhin.majumder/Pictures/ImageClassification_test_DSS/media/model_output112.jpg', img)
